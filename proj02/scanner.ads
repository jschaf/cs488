...
package Scanner is
   ...
   type Token_Type is
     (Illegal_Token,
      Keyword_Description, Keyword_Duration, Keyword_Effectiveness,
      Keyword_Exponential, Keyword_Friend, Keyword_Instance, Keyword_Interval,
      Keyword_Normal, Keyword_Number, Keyword_Point, Keyword_Range,
   ...
   subtype Keyword_Type is
     Token_Type range Illegal_Token .. Keyword_With;
